                ...
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="✂️REMOVE BG", callback_data="removebg"
                        ),
                    ],
                    [
                    ...
                    [
                        InlineKeyboardbutton(text="☠️Support☠️", url="https://t.me/{SUPPORT_GRP}"),
                        InlineKeyboardButton(text="☠️Updates☠️", url="https://t.me/{UPDATES_CH}"),
                    ],
                ]
            ),
