        ...
        if not (RemoveBG_API == ""):
            ...
            if not message.reply_to_message.empty:
                ...
                if response.status_code == 200:
                    ...
                    await message.reply_to_message.reply_text(
                        "Periksa apakah api anda benar", quote=True
                    )
                    return
            ...
            await message.reply_to_message.reply_text(
                "dapatkan api di https://www.remove.bg/b/background-removal-api dan tambahkan di Config Var",
                quote=True,
...
async def removebg_white(client, message):
    try:
        if not (RemoveBG_API == ""):
            ...
            await message.reply_to_message.reply_text(
                "dapatkan api dari https://www.remove.bg/b/background-removal-api dan tambahkan di Config Var",
                quote=True,
                disable_web_page_preview=True,
            )
    except Exception as e:
...
async def removebg_sticker(client, message):
    try:
        if not (RemoveBG_API == ""):
            ...
            await message.reply_to_message.reply_text(
                "dapatkan api dari https://www.remove.bg/b/background-removal-api dan tambahkan Config Var",
                quote=True,
                disable_web_page_preview=True,
            )
    except Exception as e:
